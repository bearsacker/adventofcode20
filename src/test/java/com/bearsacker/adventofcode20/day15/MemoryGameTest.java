...
public class MemoryGameTest {
    ...
    public void nextTurn30000000Test() {
        MemoryGame mg = new MemoryGame(asList(1, 3, 2));
        while (mg.getTurnNumber() < 30000000) {
            mg.nextTurn();
        }
